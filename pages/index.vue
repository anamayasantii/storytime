<template>
  <div class="flex flex-col items-center justify-center mt-7 text-center">
    ...
    <p class="mb-6 w-3/4 md:w-7/10 font-playFair">
      The world's most-loved social storytelling platform. Storytime connects
      a global community of 90 million readers and writers through the power of story.
    </p>
    ...
    <img
      ...
      <div class="w-full max-w-screen-xl mx-auto">
        ...
        <div class="ml-20 mr-20 flex justify-between items-center border-b-2 border-gray-300 py-4">
...
        </div>
      ...
      <div class="w-full max-w-screen-xl mx-auto">
        ...
        <!-- Book List Section -->
        <div class="flex gap-6 mt-10 ml-20 mr-5 justify-between">
            <BookRomance/>
        </div>
      </div>
      ...
      <div class="w-full max-w-screen-xl mx-auto text-left">
        ...
        <div class="ml-20">
          <button class="bg-green-100 text-white font-bold py-8 px-12 text-lg rounded-lg">
              Click Me
          </button>
        </div>
      </div>
